...
// underlyingType resolves the underlying type by iterating through the current and parent types until a kind
// is found which is not a pointer of interface.
